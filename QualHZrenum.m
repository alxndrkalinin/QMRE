...
function QQ = QualHZrenum(alpha1, alpha2, x, N, hJ, z, hJprod, hJshift, hnz)
...
A3 = exp(x(i, :) * alpha1(1)) / (1 + exp(x(i, :) * alpha1(1))) * 1 / (1 + exp(x(i, :) * alpha1(2)));
A2 = 1 / (1 + exp(x(i, :) * alpha1(1))) * exp(x(i, :) * alpha1(3)) / (1 + exp(x(i, :) * alpha1(3)));
